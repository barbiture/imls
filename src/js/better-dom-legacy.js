	...
	var ab = j.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== 0xde0b6b3a7640080.toFixed(0)),
		bb = {
			...
			numToString: function() {
				for (var a = bb.size, b = ""; --a >= 0;) if ("" !== b || 0 === a || 0 !== bb.data[a]) {
 ...
 */
function() {
	var a = /*@cc_on @_jscript_version|@*/
	void 0;
	!a || a > 8 || (document.attachEvent("onkeydown", function() {
		var a = window.event,
			b = a.srcElement,
			c = b.form;
		// return c && "textarea" !== b.type && 13 === a.keyCode && a.returnValue !== !1 ? (DOM.constructor(c).fire("submit"), !1) : void 0
	}), document.attachEvent("onclick", function() {
		var a = window.event.srcElement,
			b = a.form,
			c = a.type;
		// return !b || "submit" !== c && "reset" !== c ? void 0 : DOM.constructor(b).fire(c)
	}))
}(),
/**
...
function() {
	...
	if (a && !(a > 9)) {
		var b, c, d = function() {
			b && b.value !== c && (c = b.value, DOM.constructor(b).fire("input"))
		}, e = function() {
			b && b.checked !== c && (c = b.checked, DOM.constructor(b).fire("change"))
		}, f = function() {
			DOM.constructor(b).fire("change")
		};
		9 === a && document.attachEvent("onselectionchange", d), document.attachEvent("onfocusin", function() {
			if (b && 9 > a && (b.detachEvent("onclick", e), b.detachEvent("onchange", f), b.detachEvent("onpropertychange", d)), b = window.event.srcElement, c = b.value, 9 > a) {
				var g = b.type;
				"checkbox" === g || "radio" === g ? (b.attachEvent("onclick", e), c = b.checked) : 1 === b.nodeType && (b.attachEvent("onchange", f), ("text" === g || "password" === g || "textarea" === g) && b.attachEvent("onpropertychange", d))
			}
		})
	}
}();